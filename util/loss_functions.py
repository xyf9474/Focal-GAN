...
criterionSeg_bce = torch.nn.BCELoss()
criterionSeg_bcelogic = torch.nn.BCEWithLogitsLoss()


if __name__ == '__main__':
    a = torch.ones([2,1,50,50])
    b = torch.zeros([2,1,50,50])

    loss = BinaryDiceLoss()

    print(criterionSeg_bcelogic(a,b))
    print(loss(a,b))